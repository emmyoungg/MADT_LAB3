...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btnAddition, btnSubtraction,
            btnMultiply, btnDivision, btnEquals, btnDelete, btnPeriod, btnClear, btnClearEverything, btnSquareRoot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDelete = (Button) findViewById(R.id.btnClearEverything);
        ...
        edittext1 = (TextView) findViewById(R.id.result_id);
